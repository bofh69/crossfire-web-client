...
export function StatsCmd(data: DataView, len: number): void {
  ...
  while (reader.remaining > 0) {
    ...
    switch (stat) {
      case CS_STAT_HP:
        playerStats.hp = reader.readInt16();
        break;
      case CS_STAT_MAXHP:
        playerStats.maxhp = reader.readInt16();
        break;
      case CS_STAT_SP:
        playerStats.sp = reader.readInt16();
        break;
      case CS_STAT_MAXSP:
        playerStats.maxsp = reader.readInt16();
        break;
      case CS_STAT_GRACE:
        playerStats.grace = reader.readInt16();
        break;
      case CS_STAT_MAXGRACE:
        playerStats.maxgrace = reader.readInt16();
        break;
      case CS_STAT_STR:
        playerStats.Str = reader.readInt16();
        break;
      case CS_STAT_INT:
        playerStats.Int = reader.readInt16();
        break;
      case CS_STAT_WIS:
        playerStats.Wis = reader.readInt16();
        break;
      case CS_STAT_DEX:
        playerStats.Dex = reader.readInt16();
        break;
      case CS_STAT_CON:
        playerStats.Con = reader.readInt16();
        break;
      case CS_STAT_CHA:
        playerStats.Cha = reader.readInt16();
        break;
      case CS_STAT_POW:
        playerStats.Pow = reader.readInt16();
        break;
      case CS_STAT_LEVEL:
        playerStats.level = reader.readInt16();
        break;
      case CS_STAT_WC:
        playerStats.wc = reader.readInt16();
        break;
      case CS_STAT_AC:
        playerStats.ac = reader.readInt16();
        break;
      case CS_STAT_DAM:
        playerStats.dam = reader.readInt16();
        break;
      case CS_STAT_ARMOUR:
        playerStats.resists[0] = reader.readInt16();
        break;
      case CS_STAT_SPEED:
        playerStats.speed = reader.readInt32();
        break;
      case CS_STAT_FOOD:
        playerStats.food = reader.readInt16();
        break;
      case CS_STAT_WEAP_SP:
        playerStats.weaponSp = reader.readInt32();
        break;
      case CS_STAT_FLAGS:
        playerStats.flags = reader.readInt16();
        break;
      case CS_STAT_WEIGHT_LIM:
        playerStats.weightLimit = reader.readInt32();
        break;
      case CS_STAT_EXP64:
        playerStats.exp = reader.readInt64();
        break;
      case CS_STAT_SPELL_ATTUNE:
        playerStats.attuned = reader.readInt32();
        break;
      case CS_STAT_SPELL_REPEL:
        playerStats.repelled = reader.readInt32();
        break;
      case CS_STAT_SPELL_DENY:
        playerStats.denied = reader.readInt32();
        break;
      case CS_STAT_GOLEM_HP:
        playerStats.golemHp = reader.readInt32();
        break;
      case CS_STAT_GOLEM_MAXHP:
        playerStats.golemMaxhp = reader.readInt32();
        break;
      case CS_STAT_RACE_STR:
        playerStats.raceStr = reader.readInt16();
        break;
      case CS_STAT_RACE_INT:
        playerStats.raceInt = reader.readInt16();
        break;
      case CS_STAT_RACE_WIS:
        playerStats.raceWis = reader.readInt16();
        break;
      case CS_STAT_RACE_DEX:
        playerStats.raceDex = reader.readInt16();
        break;
      case CS_STAT_RACE_CON:
        playerStats.raceCon = reader.readInt16();
        break;
      case CS_STAT_RACE_CHA:
        playerStats.raceCha = reader.readInt16();
        break;
      case CS_STAT_RACE_POW:
        playerStats.racePow = reader.readInt16();
        break;
      case CS_STAT_BASE_STR:
        playerStats.baseStr = reader.readInt16();
        break;
      case CS_STAT_BASE_INT:
        playerStats.baseInt = reader.readInt16();
        break;
      case CS_STAT_BASE_WIS:
        playerStats.baseWis = reader.readInt16();
        break;
      case CS_STAT_BASE_DEX:
        playerStats.baseDex = reader.readInt16();
        break;
      case CS_STAT_BASE_CON:
        playerStats.baseCon = reader.readInt16();
        break;
      case CS_STAT_BASE_CHA:
        playerStats.baseCha = reader.readInt16();
        break;
      case CS_STAT_BASE_POW:
        playerStats.basePow = reader.readInt16();
        break;
      case CS_STAT_APPLIED_STR:
        playerStats.appliedStr = reader.readInt16();
        break;
      case CS_STAT_APPLIED_INT:
        playerStats.appliedInt = reader.readInt16();
        break;
      case CS_STAT_APPLIED_WIS:
        playerStats.appliedWis = reader.readInt16();
        break;
      case CS_STAT_APPLIED_DEX:
        playerStats.appliedDex = reader.readInt16();
        break;
      case CS_STAT_APPLIED_CON:
        playerStats.appliedCon = reader.readInt16();
        break;
      case CS_STAT_APPLIED_CHA:
        playerStats.appliedCha = reader.readInt16();
        break;
      case CS_STAT_APPLIED_POW:
        playerStats.appliedPow = reader.readInt16();
        break;
      case CS_STAT_RANGE: {
      ...
      default:
        if (stat >= CS_STAT_RESIST_START && stat <= CS_STAT_RESIST_END) {
          ...
          stat >= CS_STAT_SKILLINFO &&
          stat < CS_STAT_SKILLINFO + CS_NUM_SKILLS
        ) {
